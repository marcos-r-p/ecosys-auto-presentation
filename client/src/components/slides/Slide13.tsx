    ...
    <div className="flex flex-col items-center justify-center h-full px-4 sm:px-8 md:px-12 lg:px-20 xl:px-[120px] pt-8 sm:pt-12 md:pt-16 lg:pt-20 pb-8 sm:pb-10 md:pb-12 lg:pb-15 overflow-y-auto">
      <div className="max-w-7xl w-full flex flex-col gap-6 md:gap-10 lg:gap-14">
        ...
        >
          ...
          <p className="text-base text-white/80 font-medium max-w-5xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {steps.slice(0, 3).map((step, index) => (
            ...
            >
              <div
                className="absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-30 transition-opacity duration-300 rounded-xl blur-xl pointer-events-none -z-10"
                style={{
                  background: `linear-gradient(135deg, ${
                    index === 0 ? "#3b82f6" : index === 1 ? "#a855f7" : "#22c55e"
                  }, transparent)`,
                }}
              />
              <div className="relative bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-5 h-full hover:border-white/30 transition-all">
                <div className="flex flex-col items-center text-center gap-3">
                  <div
                    className={`w-14 h-14 rounded-xl bg-gradient-to-br ${step.color} p-0.5 shadow-lg`}
                  >
        ...
        <div className="flex justify-center">
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="text-white opacity-80 rotate-90">
            <path d="M9 5l7 7-7 7" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
        ...
        >
          <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-green-500/20 via-emerald-500/20 to-teal-500/20 border-2 border-green-400/50 p-8 shadow-lg shadow-green-500/20">
            <div className="flex items-start gap-4">
              <div className="w-14 h-14 rounded-lg bg-white p-0.5 shadow-lg flex-shrink-0">
